...
alias sr="sudo-rs"
alias sur="su-rs"
alias zigdev="~/.local/bin/zig-0.16.0-dev/zig"
# EZA
...
alias btooth="bluetoothctl"

# Tailscale
alias ts=tailscale

# Git
alias g-r-l="git remote"
alias g-r-a="git remote add"
alias g-r-rm="git remote rm"
alias lh=lefthook
...
alias helixhx="cd ~/.config/helix/ && helix config.toml"
...
alias lab="GITLAB_HOST=git.rachee.dev glab"
alias rse="nvim Cargo.toml"
